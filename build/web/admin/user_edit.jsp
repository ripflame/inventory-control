        ...
        <div id="page-wrapper">
            <div id="page" class="container">
                <div id="content">
                    ...
                    <s:form action="/admin/performEditUser" method="post" cssClass="marginTop20, form-horizontal, blackLabel">
                        <fieldset>
                            <s:textfield name="user.name" label="Name"
                                         value="%{#session['User'].name}" cssClass="control-label" requiredLabel="required"/>
                            <s:textfield name="user.password" label="Password"
                                         value="%{#session['User'].password}" cssClass="control-label" requiredLabel="required"/>

                            <s:submit name="guardar" value="Actualizar" cssClass="btn, btn-primary"/>
                        </fieldset>
                    </s:form>
                    <a class="btn btn-danger" href="/inventario/admin/inventario"><i class="icon-remove icon-white"></i> Cancelar</a>
                </div>
            </div>
        </div>
